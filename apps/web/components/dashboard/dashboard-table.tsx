...
export const DashBoardTable = () => {
  ...
  return (
    <div className="border rounded-lg bg-zinc-900/30 w-full overflow-hidden">
              ...
              <TableRow key={playground.id}>
                <TableCell className="font-medium">
                  <div className="flex flex-col">
                    ...
                    {/* Hides only the long description on mobile to keep rows short */}
                ...
                {/* Whitespace-nowrap prevents the date from wrapping into two lines */}
